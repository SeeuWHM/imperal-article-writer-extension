...
[![Version](https://img.shields.io/badge/version-2.6.0-green)](https://github.com/SeeuWHM/imperal-article-writer-extension/releases)
...
../.venv-ext/bin/python -m pytest tests/ -q   # 75 tests — MockContext + monkeypatched call_backend, no network
